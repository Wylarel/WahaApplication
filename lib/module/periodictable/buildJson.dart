...
const kColorMap = {
  Category.alkaliMetal         : [ 0xFFD32F2F, 0xFFD32F2F ],
  Category.alkalineEarthMetal  : [ 0xFFF46B45, 0xFFF46B45 ],
  Category.lanthanide          : [ 0xFF8BC34A, 0xFF8BC34A ],
  Category.actinide            : [ 0xFF0ED2F7, 0xFF0ED2F7 ],
  Category.transitionMetal     : [ 0xFFFFCA28, 0xFFFFCA28 ],
  Category.postTransitionMetal : [ 0xFF11998E, 0xFF11998E ],
  Category.metalloid           : [ 0xFF0072FF, 0xFF0072FF ],
  Category.reactiveNonmetal    : [ 0xFF536DFE, 0xFF536DFE ],
  Category.nobleGas            : [ 0xFF9796F0, 0xFF9796F0 ],
  Category.unknown             : [ 0xFF757F9A, 0xFF757F9A ],
};
